     ...
     <div class="right-side-navbar d-flex align-items-center justify-content-end">
         ...
         <ul class="right-side-content d-flex align-items-center">
             ...
             <li class="nav-item dropdown">
                 <button type="button" class="btn dropdown-toggle font-15 text-dark" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">فارسی<i class="arrow_carrot-down"></i></button>
                         ...
                         <div class="message-box" id="messageBox">
                             <a href="#" class="dropdown-item">
                                 ...
                                 <span class="message-text">
                                     <span> شما وارد پنل مدیریت وبلاگ خود شدید ! </span>
